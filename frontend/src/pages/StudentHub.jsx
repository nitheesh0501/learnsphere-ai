...
export default function StudentHub({ onNavigateToQuiz, readinessScore, setReadinessScore, addToast }) {
  ...
  // TASK 2: REACTIVE 6-WEEK RECOVERY ROADMAP COMPUTED VIA useMemo ON [subjects]
  const dynamicRoadmap = useMemo(() => {
    // Filter active weak or review subjects to prioritize in the 6-week stepper
    const weakList = subjects.filter(s => s.internalMarks !== '' && Number(s.internalMarks) < 40);
  ...
  // TASK 2: REACTIVE AI STUDY PRIORITIES COMPUTED VIA useMemo ON [subjects]
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-2 sm:px-4">
                    ...
                    <div className="flex items-center space-x-4 shrink-0">
                      ...
                      <div className="flex items-center space-x-1">
                        <input
                          ...
                          className={`border rounded-lg px-2 py-1 text-xs text-center font-extrabold focus:outline-none focus:border-[#701C34] w-16 sm:w-18 ${
                            sub.internalMarks === '' || sub.internalMarks === null
      ...
      {/* CARD 3: 6-Week Adaptive Study Roadmap (DYNAMICALLY RE-CALCULATED FOR SEM 3 VIA useMemo) */}
      ...
      {/* CARD 4: AI SUGGESTED STUDY PRIORITIES FOR SEMESTER 3 COURSES (REACTIVELY COMPUTED VIA useMemo) */}
